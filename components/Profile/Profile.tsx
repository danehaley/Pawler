...
import BreedPopover from "../Popover/BreedPopover";

const Profile = ({ petInfo, breedInfo }: any) => {
  return (
      ...
      <article>
        <section className="mb-2 grid grid-cols-2">
          <section className="justify-self-start ">
            ...
            {BreedPopover(
              <h2 className="text-sm text-neutral-600 flex cursor-pointer">
                {breedInfo.name}{" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-3 w-3 m-0.5 mt-1"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
